...
export const products = [
  // Flow Meters
  { id: 1, name: 'Electromagnetic Flow Meter', description: 'Compact/Remote/Hygenic flow meter for water, wastewater, chemicals, food, pharma with high accuracy.', price: 0, image: './assets/flow-meter.png', category: 'Flow' },
  ...
  { id: 31, name: 'Water Quality Monitoring System', description: 'Air quality monitoring station for dust and pollutants.', price: 0, image: './assets/Water-quality.png', category: 'Water' },
