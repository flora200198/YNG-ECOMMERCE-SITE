...
export const calibrationServicesData = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          "Reduced Downtime: Keep your operations running smoothly with minimal interruptions.",
          "Increased Efficiency: Ensure your equipment performs at its best, boosting productivity.",
          "Cost Savings: Extend the life of your instruments and avoid costly replacements.",
          "Expert Support: Rely on our certified professionals for precision and reliability.",
        ],
      },
    ],
...
export const CheckoutProvider = ({ children }) => {
  ...
  return (
    <CheckoutContext.Provider value={{ businessDetails, businesses,ProductDetails, selectedProduct, setSelectedProduct, products, cartItems, setCartItems, shippingAddress, setShippingAddress, calibrationServicesData }}>
      {children}
